...
<BODY> 
	...
	<div class="top-content">
		...
		include $_SERVER["DOCUMENT_ROOT"]."/Trabalho-LP4/connection.php";
  		...
  		$tab = mysqli_query($con,"select nm_musica, nm_artista, nm_album, year(dt_lancamento), nm_genero, tipo_musica, txt_comentario from musicas");
		  ...
		  while ($lin = mysqli_fetch_assoc($tab)) {
			echo "<div><tbody><tr><td>".$lin['nm_musica']."</td><td>".$lin['nm_artista']."</td><td>".$lin['nm_album']."</td><td>".$lin['year(dt_lancamento)']."</td><td>".$lin['nm_genero']."</td><td>".$lin['tipo_musica']."</td><td>"."<button type='button' class='btn btn-info btn-lg' data-toggle='modal' data-target='#myModal'>Visualizar comentário</button>"."</td></tr></tbody>".
			...
			"<div class='modal fade' id='myModal' role='dialog'>".
          	...
          	"<h4 class='modal-title' style='color:black;'>Comentário</h4>".
        		  "</div>".
		...
		echo "<br><br>";
		echo "<h3>Cookie salvo -> ".$_COOKIE['usuario']."</h3>";
